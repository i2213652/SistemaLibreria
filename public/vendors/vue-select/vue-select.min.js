                        ...
                        watch: {
                            filteredOptions: function () {
                                for (
                                    ...
                                    if (
                                        this.selectable(this.filteredOptions[t])
                                    ) {
                ...
                const m = p(
                        {
                            ...
                            computed: {
                                ...
                                stateClasses: function () {
                                    return {
                                        ...
                                        "vs--searching":
                                            this.searching && !this.noDrop,
                                        "vs--searchable":
                                            this.searchable && !this.noDrop,
                            ...
                            watch: {
                                ...
                                value: {
                                    ...
                                    handler: function (t) {
                                        this.isTrackingValues &&
                                            this.setInternalValueFromOptions(t);
                                    },
                                },
                                multiple: function () {
                                    this.clearSelection();
                            ...
                            methods: {
                                setInternalValueFromOptions: function (t) {
                                    var e = this;
                                    Array.isArray(t)
                                        ? (this.$data._value = t.map(function (
                                              t
                                          ) {
                                              return e.findOptionFromReducedValue(
                                                  t
                                              );
                                          }))
                                        : (this.$data._value =
                                ...
                                deselect: function (t) {
                                    ...
                                    this.$emit("option:deselecting", t),
                                        this.updateValue(
                                            this.selectedValue.filter(function (
                                                n
                                            ) {
                                                return !e.optionComparator(
                                                    n,
                                                    t
                                                );
                                            })
                                ...
                                toggleDropdown: function (t) {
                                    ...
                                    n && t.preventDefault();
                                    var o = [].concat(
                                        e()(this.$refs.deselectButtons || []),
                                        e()([this.$refs.clearButton] || 0)
                                    );
                                                    ...
                                                    t._l(
                                                        ...
                                                        function (e) {
                                                            return t._t(
                                                                ...
                                                                {
                                                                    option: t.normalizeOptionForSlot(
                                                                        e
                                                                    ),
                                                                    deselect:
                                                                        t.deselect,
